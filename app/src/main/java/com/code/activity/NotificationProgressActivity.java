...
/**
 * Created by Ansen on 2017/1/3 09:49.
 *
 ...
 * @Description: TODO
 */
public class NotificationProgressActivity extends Activity  implements View.OnClickListener {
    ...
    private void showCustomProgressNotify(String status) {
        RemoteViews mRemoteViews = new RemoteViews(getPackageName(), R.layout.activity_notification_progress);
        mRemoteViews.setImageViewResource(R.id.custom_progress_icon, R.mipmap.notification_icon);
