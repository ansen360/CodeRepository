...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        itemCount = attribute.getInt(R.styleable.WheelView_itemCount, itemCount);
        ...
        controlHeight = itemCount * unitHeight;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (controlWidth != 0) {
            setMeasuredDimension(getMeasuredWidth(), itemCount * unitHeight);
        }
    }
