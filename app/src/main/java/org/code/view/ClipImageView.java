...
/**
 * Created by Ansen on 2017/9/5 17:15.
 *
 ...
 * @Description: 裁剪图片
 * mCropView.setBitmap(mScreenBitmap);
 * mCropView.setVisibility(View.VISIBLE);   //默认设置INVISIBLE
 * mCropView.reset();
 */
public class ClipImageView extends AppCompatImageView {
    ...
    public boolean isInPressArea(int x, int y) {
        Rect temp1 = new Rect(mPressLTArea.left - 80, mPressLTArea.top - 80, mPressLTArea.right + 80, mPressLTArea.bottom + 80);
        Rect temp2 = new Rect(mPressRTArea.left - 80, mPressRTArea.top - 80, mPressRTArea.right + 80, mPressRTArea.bottom + 80);
        Rect temp3 = new Rect(mPressRBArea.left - 80, mPressRBArea.top - 80, mPressRBArea.right + 80, mPressRBArea.bottom + 80);
        Rect temp4 = new Rect(mPressLBArea.left - 80, mPressLBArea.top - 80, mPressLBArea.right + 80, mPressLBArea.bottom + 80);
